...
def main():
    ...
    func1_parser.add_argument(
        "--data_type", default="phy", help="Data type to load; default: 'phy'."
    )
    ...
    if args.command == "summary_files":
        legend_data_monitor.monitoring.build_new_files(
            args.path, args.period, args.run, data_type=args.data_type
        )
        ...
        start_key = legend_data_monitor.utils.get_start_key(
        ...
        for k in results.keys():
            ...
            legend_data_monitor.monitoring.box_summary_plot(
                period,
                current_run,
                pars_dict,
                det_info,
                results[k],
                legend_data_monitor.utils.MTG_PLOT_INFO[k],
                output_folder,
                data_type,
                save_pdf,
